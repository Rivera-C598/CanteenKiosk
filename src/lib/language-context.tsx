...
export const translations: Record<Language, Dictionary> = {
  en: {
    ...
    'payment.cashless_info': 'Scan your QR card at the cashless terminal after placing your order. Your balance will be deducted automatically.',
  ...
  fil: {
    ...
    'payment.cashless_info': 'I-scan ang iyong QR card sa cashless terminal pagkatapos umorder. Awtomatikong mababawas ang iyong balanse.',
  ...
  ceb: {
    ...
    'payment.cashless_info': 'I-scan ang imong QR card sa cashless terminal human mag-order. Awtomatiko nga mabawasan ang imong balanse.',
