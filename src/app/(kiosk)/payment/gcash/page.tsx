  ...
  return (
    <div className="h-[100dvh] w-screen flex flex-col bg-background overflow-hidden">
      ...
      <header className="flex items-center justify-between gap-3 px-4 sm:px-8 py-3 sm:py-4 bg-surface-container-low shrink-0">
        ...
        {/* Countdown */}
        <div className={`flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 rounded-full font-headline font-black text-sm sm:text-lg shrink-0 ${
      ...
      {expired ? (
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-4 sm:px-8 gap-4 sm:gap-6 overflow-y-auto py-4">
          ...
          {/* QR Code area */}
          <div className="bg-surface-container-lowest rounded-xl p-4 sm:p-6 shadow-ambient flex flex-col items-center gap-4 w-full max-w-xs">
            {gcashAccount?.qrCodeImage ? (
              ...
              <div className="w-40 h-40 sm:w-48 sm:h-48 bg-surface-container rounded-xl flex flex-col items-center justify-center gap-3">
